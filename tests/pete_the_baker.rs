...
// 
// Write a function cakes(), which takes the recipe (HashMap<&str, u32>) 
// and the available ingredients (also a HashMap<&str, u32>) and returns 
// the maximum number of cakes Pete can bake (u32). For simplicity there 
// are no units for the amounts (e.g. 1 lb of flour or 200 g of sugar are 
...
use rust_codewars::pete_the_baker::*;
